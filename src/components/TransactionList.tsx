...
export function TransactionList() {
  ...
  const handleGenerateAnnualPDF = () => {
    try {
      ...
      alert(`Erro ao gerar o relatório anual: ${error.message}`);
    }
  };
  ...
  const handleGenerateMonthlyPDF = () => {
    try {
      ...
      console.error('Erro ao gerar PDF:', error);
      alert(`Erro ao gerar o relatório mensal: ${error.message}`);
    }
  };
  ...
  // Combinar categorias padrão com categorias personalizadas para os filtros
  const allCategories = [
    ...CATEGORIES.income, 
    ...CATEGORIES.expense,
